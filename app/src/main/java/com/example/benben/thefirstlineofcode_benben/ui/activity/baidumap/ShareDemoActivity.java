...
import com.example.benben.thefirstlineofcode_benben.baidu.overlayutil.PoiOverlay;
...
public class ShareDemoActivity extends Activity implements
    ...
    public static void startShareDemoActivity(Activity activity) {
        Intent intent = new Intent(activity, ShareDemoActivity.class);
