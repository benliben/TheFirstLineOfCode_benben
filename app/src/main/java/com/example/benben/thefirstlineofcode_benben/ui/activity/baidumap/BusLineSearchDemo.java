...
import com.example.benben.thefirstlineofcode_benben.ui.overlayutil.BusLineOverlay;
...
public class BusLineSearchDemo extends FragmentActivity implements
    ...
    public static void startBusLineSearchDemo(Activity activity) {
        Intent intent = new Intent(activity, BusLineSearchDemo.class);
